...
################### hvdex ###################
# LEAP_HOME_POSITION = [ 0.1360,  0.6060,  0.5944,  0.9149,  0.0647,  0.5912,  0.5493,  0.8639, -0.1275,  0.7218,  0.6003,  0.8635,  0.9088,  1.1512,  0.1491,  0.1207]
...
FLEXIV_POSITIONS = {
    ...
    # ################### hvdex ###################
    'home_js': [-15.32730505, -25.00662998, 20.13074862, 93.17200899, -2.88300724, 16.29160071, 24.82040823],
    # 'home_js': [-11.8, -42.1, 17.66, 95.03, -12.96, 42.65, 25.64],
    # 'home_js': [-9.24, -43.66, 13.83, 100.68, -4.29, 60.35, 8.01],
    # 'home_js': [-8.57, -40.30, 10.79, 115.87, -1.58, 72.03, 6.40],
    # 'home_js': [-12.36, -38.33, 0.38, 106.19, -7.11, 55.49, 6.12],
    # 'home_js': [-3.87, -36.97, 6.34, 110.98, -6.98, 60.82, 6.04],
    # 'home_js': [17.29, -32.86, -10.05, 107.95, 4.15, 51.44, 15.67],
}

# JAKA_IP = "192.168.130.98"
...
CAM_TYPE = "realsense" # "realsense" or "webcam"
