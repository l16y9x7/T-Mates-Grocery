...
```text
位姿准备：      http://168.192.1.226:8084/pose/prepare
位姿健康检查：  http://168.192.1.226:8084/pose/health
导航移动：      http://168.192.1.226:8081/navigation/navigate
导航健康检查：  http://168.192.1.226:8081/navigation/health
```
